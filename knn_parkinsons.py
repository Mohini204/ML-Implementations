...
df = pd.read_csv(r'/Users/venkatasamyuktamalapaka/Downloads/final_project/parkinsons.csv')
...
def k_folds(data_to_load):
 ...
 grouped = data_to_load.groupby(['Diagnosis'])
 print(grouped)
...
#         for m in range(1,21):
#             df__after_shuffle = (sklearn.utils.shuffle(data, n_samples=150, random_state=40))
...
#             X_train = train.drop(['Diagnosis'], axis=1)[:].values
...
#     plt.errorbar(x_axis, avg, yerr=standard_deviation,capsize=5, color='b',  markersize=4, linewidth=1,linestyle='-', fmt='.k')
#     xi = list(range(len(x_axis)))
#     plt.ylim(0.8,1.0)       
#     plt.xlabel('K-value')
#     plt.ylabel('Average accuracy')
#     plt.title('Line plot with error bars of Training data on Parkinsons dataset')
...
#     plt.xlabel('K-value')
#     plt.ylabel('Average accuracy')
#     plt.title('Line plot with error bars of Testing data on Parkinsons dataset')
...
def main():
    ...
    plt.xlabel('K-value')
    plt.ylabel('Average accuracy')
    plt.title('Line plot with error bars of Accuracy of Training data on Parkinsons dataset')
    plt.xticks(x_axis,x_axis)
    plt.show()
    ...
    plt.xlabel('K-value')
    plt.ylabel('Average accuracy')
    plt.title('Line plot with error bars of Accuracy of Testing data on Parkinsons dataset')
    plt.xticks(x_axis_test,x_axis_test)
    ...
    plt.title('Line plot of F1 score of Training data on Parkinsons dataset')
    ...
    plt.xlabel('K-value')
    plt.ylabel('Average F1 score')
    plt.title('Line plot of F1 score of Test data on Parkinsons dataset')
