...
def k_folds(data_to_load):
 ...
 grouped = data_to_load.groupby(['Number'])
 print(grouped,'sam')
...
def main():
    ...
    for k in range(1,11,2):
        ...
        for m in range(1,11):
            ...
            X_train = train.drop(['Number'], axis=1)[:].values
            X_test = test.drop(['Number'], axis=1)[:].values
            # print(y_train)
            # print("-----------------------------------")
            # print(y_test)
            # print("-----------------------------------")
    ...
    print(x_axis_test,train_f1.values(),test_f1.values())
    ...
    plt.title('Line plot with error bars of Accuracy of Training data on Number dataset')
    ...
    plt.xlabel('K-value')
    plt.ylabel('Average accuracy')
    plt.title('Line plot with error bars of Accuracy of Testing data on Number dataset')
    ...
    plt.title('Line plot of F1 score of Training data on Number dataset')
    ...
    plt.xlabel('K-value')
    plt.ylabel('Average F1 score')
    plt.title('Line plot of F1 score of Test data on Number dataset')
