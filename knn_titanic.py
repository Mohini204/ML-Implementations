...
df = pd.read_csv(r'/Users/venkatasamyuktamalapaka/Downloads/final_project/titanic.csv')
...
def k_folds(data_to_load):
 ...
 grouped = data_to_load.groupby(['Survived'])
 print(grouped)
...
def main():
    ...
    plt.title('Line plot with error bars of Accuracy of Training data on Titanic dataset')
    ...
    plt.xlabel('K-value')
    plt.ylabel('Average accuracy')
    plt.title('Line plot with error bars of Accuracy of Testing data on Titanic dataset')
    ...
    plt.title('Line plot of F1 score of Training data on Titanic dataset')
    ...
    plt.xlabel('K-value')
    plt.ylabel('Average F1 score')
    plt.title('Line plot of F1 score of Test data on Titanic dataset')
